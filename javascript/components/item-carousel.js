...
export const handleItemCarousel = () => {
    leftButton.addEventListener('click', () => {
        ...
        let style = currentCard.currentStyle || window.getComputedStyle(currentCard)
        let size = currentCard.clientWidth + parseFloat(style.marginLeft) + parseFloat(style.marginRight)
